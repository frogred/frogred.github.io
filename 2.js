        ...
        function choose() {
            ...
            var num = level.options[index].value;
            if (num == "min") {
                window.open("index.html", "_self");
            }
            else if (num == "mid") {
                window.open("222.html", "_self");
            }
            else {
                window.open("333.html", "_self");
            }
        }
...
//方格点击事件 _i：坐标i _j:坐标j e:鼠标事件
        function block_click(_i, _j, e) {
            ...
            clearInterval(clock);//游戏胜利结束计时，清除定时器
            alert("游戏胜利");
        }